      ...
      <div class="bannerInner fadeInRight wow">
        <div class="ctn-banner">
          <h3><span>brand new </span><br>
            ...
            <p>{$settings.site_name} is made so even investors with zero trading experience are successfully making a profit. Our program, unlike any other, guarantees fix hourly interest for investors regardless of market conditions.</p>
    ...
    <div class="becomeContainer">
      <div class="becomeInner fadeInRight wow">
        <div class="ctn-become">
          <p>The best investment plan of {'Y'|date}. You can earn<span> up 40% hourly.</span></p>
        </div>
      </div>
    </div>
...
<div class="depositContainer">
  ...
  <div class="footerContainer">
    <div class="footerInner">
      <div class="ft-row1">
        <h3>&copy; {'Y'|date}. <a href="?a=home">{$settings.site_name}</a> ALL RIGHTS RESERVED</h3>
      </div>
